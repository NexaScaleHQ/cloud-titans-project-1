...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/private/NCS.key -out /etc/ssl/certs/NCS.crt
...
openssl req -newkey rsa:2048 -nodes -keyout /etc/pki/tls/private/NCS.key -x509 -days 365 -out /etc/pki/tls/certs/NCS.crt
...
mysql -h tcs-database.cdqpbjkethv0.us-east-1.rds.amazonaws.com -u NCSadmin -p 
